import { getAllPaths, getRandomFilePath, hasAllTokens, now, randf_range, randomLetters, RoutingInfo, serverConsoleLog, serverLog, shortenName, timeSinceLastOnline, validateUsername } from "../utils.ts";
